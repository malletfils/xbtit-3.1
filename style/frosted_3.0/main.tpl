...
<head>
  ...
  <meta http-equiv="content-type" content="text/html; charset=<tag:main_charset />" />
    <!-- Bootstrap Core CSS -->
    <link href="style/frosted_3.0/css/bootstrap.css" rel="stylesheet">
    <!-- Theme CSS -->
    <link href="style/frosted_3.0/main.css" rel="stylesheet">
    <!-- Custom Fonts -->
...
<body>
    ...
    <script src="style/frosted_3.0/js/bootstrap.min.js"></script>
